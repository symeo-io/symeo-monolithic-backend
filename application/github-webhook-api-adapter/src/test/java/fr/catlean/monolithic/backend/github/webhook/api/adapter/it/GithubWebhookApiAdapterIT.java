package fr.catlean.monolithic.backend.github.webhook.api.adapter.it;
...
public class GithubWebhookApiAdapterIT extends AbstractGithubWebhookAdapterIT {
    ...
    void should_validate_and_consume_github_webhook_event() throws IOException {
        ...
        assertThat(organizationAdapterMock.getOrganizations().get(0).getVcsOrganization().getVcsId()).isEqualTo(
                "github-" + githubWebhookEventDTO.getInstallation().getAccount().getId());
    }
