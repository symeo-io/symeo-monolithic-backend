...
import fr.catlean.monolithic.backend.application.rest.api.adapter.mapper.UserContractMapper;
...
import static fr.catlean.monolithic.backend.application.rest.api.adapter.mapper.OnboardingContractMapper.getOnboarding;
import static fr.catlean.monolithic.backend.application.rest.api.adapter.mapper.OnboardingContractMapper.getPostOnboardingResponseContract;
...
public class UserRestApiAdapter implements UserApi {
    ...
    public ResponseEntity<CurrentUserResponseContract> getCurrentUser() {
        try {
            ...
            currentUserResponseContract.setErrors(List.of(CatleanErrorContractMapper.catleanExceptionToContract(catleanException)));
