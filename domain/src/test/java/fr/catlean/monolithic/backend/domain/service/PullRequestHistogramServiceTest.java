...
import static fr.catlean.monolithic.backend.domain.query.PieceCurveWithAverageQueryTest.buildPullRequestPullRequestLimitView;
...
public class PullRequestHistogramServiceTest {
    ...
    @Test
    void should_compute_and_save_pull_request_size_histogram_given_simple_pull_request_cases() throws CatleanException {
        // Given
        ...
        final List<PullRequestView> pullRequestViews = List.of(
                buildPullRequestPullRequestLimitView(2000, stringToDate("2022-01-01"), null, null, PullRequest.OPEN),
                buildPullRequestPullRequestLimitView(400, stringToDate("2021-01-01"), null, null, PullRequest.OPEN),
                buildPullRequestPullRequestLimitView(200, stringToDate("2022-05-01"), null, null, PullRequest.OPEN),
                buildPullRequestPullRequestLimitView(1000, stringToDate("2022-01-01"), null, null, PullRequest.OPEN),
                buildPullRequestPullRequestLimitView(1000, stringToDate("2022-01-01"), stringToDate("2022-01-15"),
                        null, PullRequest.MERGE),
                buildPullRequestPullRequestLimitView(2000, stringToDate("2022-01-11"), stringToDate("2022-03-01"),
                        null, PullRequest.MERGE),
                buildPullRequestPullRequestLimitView(100, stringToDate("2022-01-21"), stringToDate("2022-01-30"),
                        null, PullRequest.MERGE),
                buildPullRequestPullRequestLimitView(100, stringToDate("2022-01-21"), stringToDate("2022-04-01"),
                        null, PullRequest.MERGE)
        );
    ...
    @Test
    void should_compute_and_save_pull_request_time_histogram_given_simple_pull_request_cases() throws CatleanException {
        // Given
        final PullRequestHistogramService pullRequestHistogramService =
                new PullRequestHistogramService();
        final String repositoryName1 = faker.pokemon().name() + "-1";
        ...
        final List<PullRequestView> pullRequestViews = List.of(
                buildPullRequestPullRequestLimitView(0, stringToDate("2021-01-01"), null, null, PullRequest.OPEN),
                buildPullRequestPullRequestLimitView(0, stringToDate("2022-01-01"), null, null, PullRequest.OPEN),
                buildPullRequestPullRequestLimitView(0, stringToDate("2022-01-01"), null, null, PullRequest.OPEN),
                buildPullRequestPullRequestLimitView(0, stringToDate("2022-01-01"), stringToDate("2022-01-15"),
                        null, PullRequest.MERGE),
                buildPullRequestPullRequestLimitView(0, stringToDate("2022-05-01"), null, null, PullRequest.OPEN),
                buildPullRequestPullRequestLimitView(0, stringToDate("2022-01-11"), stringToDate("2022-03-01"),
                        null, PullRequest.MERGE),
                buildPullRequestPullRequestLimitView(0, stringToDate("2022-01-21"), stringToDate("2022-01-30"),
                        null, PullRequest.MERGE),
                buildPullRequestPullRequestLimitView(0, stringToDate("2022-01-21"), stringToDate("2022-04-01"),
                        null, PullRequest.MERGE)
        );
