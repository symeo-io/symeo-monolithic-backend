...
public class HistogramQueryTest {
    ...
    void should_read_histogram_for_organisation_and_team_and_type() throws CatleanException {
        ...
        final HistogramQuery histogramQuery = new HistogramQuery(expositionStorageAdapter, organizationAccountAdapter);
        ...
        // When
        when(organizationAccountAdapter.findOrganizationForName(organizationName)).thenReturn(
    ...
    void should_throw_not_found_organisation_exception_when_reading_pull_request_histogram() throws CatleanException {
        ...
        // When
        when(organizationAccountAdapter.findOrganizationForName(organizationName))
