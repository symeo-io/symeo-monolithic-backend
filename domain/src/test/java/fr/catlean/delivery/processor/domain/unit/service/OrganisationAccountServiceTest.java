...
public class OrganisationAccountServiceTest {
    ...
    void should_return_organisation_given_a_name() {
        ...
        final OrganisationAccountService organisationAccountService =
                new OrganisationAccountService(organisationAccountAdapter);
        final OrganisationAccount expectedOrganisationAccount =
        ...
        final OrganisationAccount organisationAccount =
                organisationAccountService.getOrganisationForName(organisationName);
