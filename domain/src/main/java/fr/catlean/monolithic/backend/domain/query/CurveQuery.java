...
import static fr.catlean.monolithic.backend.domain.model.insight.Curve.buildTimeToMergeCurve;

@AllArgsConstructor
public class CurveQuery {
    private final ExpositionStorageAdapter expositionStorageAdapter;

    public Curve computeTimeToMergeCurve(Organization organization, String teamName) {
