...
@Builder
@Slf4j
public class CollectTestingDataForOrganizationAndTeamJobRunnable extends AbstractTasksRunnable<Repository> implements JobRunnable {
    @NonNull
    ...
    public void run(final Long jobId) throws SymeoException {
        executeAllTasks(this::collectTestingDataForRepository, jobStorage, jobId);
    }

    private void collectTestingDataForRepository(Repository repository) throws SymeoException {
    ...
    public static final String JOB_CODE = "COLLECT_TESTING_DATA_FOR_REPOSITORIES_JOB";
