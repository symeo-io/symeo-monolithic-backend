...
import static io.symeo.monolithic.backend.domain.model.insight.CycleTime.computeCycleTimeForMergeOnPullRequestMatchingDeliverySettings;
...
public class AverageCycleTime {
    ...
    private static Function<PullRequestView, CycleTime> cycleTimeForTimeToMergeOnPullRequestMatchingDeliverySettings(
            final List<PullRequestView> pullRequestViewsMergedOnMatchedBranches,
            final List<Commit> allCommits) {
        return pullRequestView -> computeCycleTimeForMergeOnPullRequestMatchingDeliverySettings(pullRequestView,
