...
public class JsonToGeneratorMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final URL inputJsonUrl = new URL("file:///Users/ilysse/Workspace/SYMEO-IO/symeo-monolithic-backend/symeo-json-to-pojo-generator/src/main/resources/single_github_repo.json");
        final File outputJavaClassDirectory = new File("/Users/ilysse/Workspace/SYMEO-IO/symeo-monolithic-backend" +
