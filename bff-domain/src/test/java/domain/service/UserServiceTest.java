...
import io.symeo.monolithic.backend.domain.bff.service.organization.UserService;
...
public class UserServiceTest {
    ...
    @Test
    void should_return_existing_user() throws SymeoException {
        // Given
    ...
    @Test
    void should_update_existing_pending_user_to_active_user_given_an_email() throws SymeoException {
        // Given
        final UserStorageAdapter userStorageAdapter = mock(UserStorageAdapter.class);
        final EmailDeliveryAdapter emailDeliveryAdapter = mock(EmailDeliveryAdapter.class);
        final UserService userService = new UserService(userStorageAdapter, emailDeliveryAdapter);
    ...
    @Test
    void should_not_get_user_and_create_it_and_return_it() throws SymeoException {
        // Given
        final UserStorageAdapter userStorageAdapter = mock(UserStorageAdapter.class);
        final EmailDeliveryAdapter emailDeliveryAdapter = mock(EmailDeliveryAdapter.class);
        final UserService userService = new UserService(userStorageAdapter, emailDeliveryAdapter);
    ...
    @Test
    void should_get_all_users_given_an_organization() throws SymeoException {
        // Given
        final UserStorageAdapter userStorageAdapter = mock(UserStorageAdapter.class);
        final EmailDeliveryAdapter emailDeliveryAdapter = mock(EmailDeliveryAdapter.class);
        final UserService userService = new UserService(userStorageAdapter, emailDeliveryAdapter);
    ...
    @Test
    void should_create_users_and_send_mail() throws SymeoException {
        // Given
    ...
    @Test
    void should_remove_user_for_id() throws SymeoException {
        // Given
        final UserStorageAdapter userStorageAdapter = mock(UserStorageAdapter.class);
        final EmailDeliveryAdapter emailDeliveryAdapter = mock(EmailDeliveryAdapter.class);
        final UserService userService = new UserService(userStorageAdapter, emailDeliveryAdapter);
