...
public class GithubUser2DTO {
    ...
    public GithubUser2DTO withLogin(String login) {
        this.login = login;
        return this;
    }
    ...
    public GithubUser2DTO withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public GithubUser2DTO withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public GithubUser2DTO withAvatarUrl(String avatarUrl) {
        this.avatarUrl = avatarUrl;
        return this;
    }
    ...
    public GithubUser2DTO withGravatarId(String gravatarId) {
        this.gravatarId = gravatarId;
        return this;
    }
    ...
    public GithubUser2DTO withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public GithubUser2DTO withHtmlUrl(String htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public GithubUser2DTO withFollowersUrl(String followersUrl) {
        this.followersUrl = followersUrl;
        return this;
    }
    ...
    public GithubUser2DTO withFollowingUrl(String followingUrl) {
        this.followingUrl = followingUrl;
        return this;
    }
    ...
    public GithubUser2DTO withGistsUrl(String gistsUrl) {
        this.gistsUrl = gistsUrl;
        return this;
    }
    ...
    public GithubUser2DTO withStarredUrl(String starredUrl) {
        this.starredUrl = starredUrl;
        return this;
    }
    ...
    public GithubUser2DTO withSubscriptionsUrl(String subscriptionsUrl) {
        this.subscriptionsUrl = subscriptionsUrl;
        return this;
    }
    ...
    public GithubUser2DTO withOrganizationsUrl(String organizationsUrl) {
        this.organizationsUrl = organizationsUrl;
        return this;
    }
    ...
    public GithubUser2DTO withReposUrl(String reposUrl) {
        this.reposUrl = reposUrl;
        return this;
    }
    ...
    public GithubUser2DTO withEventsUrl(String eventsUrl) {
        this.eventsUrl = eventsUrl;
        return this;
    }
    ...
    public GithubUser2DTO withReceivedEventsUrl(String receivedEventsUrl) {
        this.receivedEventsUrl = receivedEventsUrl;
        return this;
    }
    ...
    public GithubUser2DTO withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public GithubUser2DTO withSiteAdmin(Boolean siteAdmin) {
        this.siteAdmin = siteAdmin;
        return this;
    }
    ...
    public GithubUser2DTO withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GithubUser2DTO.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("login");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GithubUser2DTO) == false) {
            return false;
        }
        GithubUser2DTO rhs = ((GithubUser2DTO) other);
