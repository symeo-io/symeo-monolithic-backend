...
public class GithubRepositoriesCollectionIT extends AbstractGithubAdapterIT {
    ...
    @Autowired
    public GithubAdapterConfiguration.GithubJwtTokenProviderMock githubJwtTokenProvider;
    @Autowired
    ...
    @Test
    void should_get_repositories_for_multiple_organization_and_refresh_token() throws IOException, CatleanException {
        // Given
        final GithubInstallationDTO[] githubInstallationDTOS = getStubsFromClassT("get_github_app_installations",
