...
//                                .id(UUID.randomUUID())
//                                .vcsOrganization(VcsOrganization.builder().vcsId(faker.rickAndMorty().character())
//                                .build())
//                                .build()
//                )
//                .build());
...
//        assertThat(lastTwoJobsInProgressOrFinishedForVcsDataCollectionJob.get(0)).isEqualTo(entityToDomain
//        (expectedJob2));
//        assertThat(lastTwoJobsInProgressOrFinishedForVcsDataCollectionJob.get(1)).isEqualTo(entityToDomain
//        (expectedJob1));
//    }
}
